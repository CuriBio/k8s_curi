...
resource "aws_ecr_repository" "uploader_ecr_repo" {
  name                 = "uploader"
...
resource "aws_ecr_lifecycle_policy" "uploader_ecr_lifecycle_policy" {
  repository = aws_ecr_repository.uploader_ecr_repo.name
