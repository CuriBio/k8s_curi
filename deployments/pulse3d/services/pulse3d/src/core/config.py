...
DASHBOARD_URL = config(
    "DASHBOARD_URL", cast=str, default="https://dashboard.curibio-test.com"
)

PULSE3D_UPLOADS_BUCKET = config(
    "UPLOADS_BUCKET_ENV", cast=str, default="test-pulse3d-uploads"
)
MANTARRAY_LOGS_BUCKET = config(
    "MANTARRAY_LOGS_BUCKET_ENV", cast=str, default="test-mantarray-logs"
)
